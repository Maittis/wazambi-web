...
export default function SolutionPage({ solution }: SolutionPageProps) {
  ...
  return (
    <>
      {/* Hero */}
      <section className="bg-navy pt-[155px] pb-16 md:pt-[170px] md:pb-24">
        <div className="container-wz grid items-center gap-10 md:grid-cols-[1fr_38%]">
          <Reveal>
            <p className="eyebrow text-gold">Wazambi {solution.title}</p>
          ...
          <Reveal direction="right" delay={200}>
            <div className="relative mx-auto w-full" style={{ aspectRatio: "520/460" }}>
      ...
      <section className="bg-white py-20 md:py-24">
        <div className="container-wz">
          ...
          />
          <Reveal className="mx-auto mt-12 max-w-[800px]" delay={100}>
            <div className="flex flex-col overflow-hidden rounded-[14px] bg-paper md:flex-row">
              ...
              <div className="p-8">
                <p className="text-[12px] font-semibold uppercase tracking-wide text-electric-blue">{relatedResult.industry}</p>
      ...
      {relatedCourse && (
        <section className="bg-paper py-20 md:py-24">
          <div className="container-wz text-center">
            ...
            />
            <Reveal className="mx-auto mt-10 max-w-[320px]" delay={100}>
