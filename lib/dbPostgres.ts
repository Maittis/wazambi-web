...
const TABLES: Record<CollectionName, TableDef> = {
  ...
  leads: {
    ...
    fields: [
      ...
      { k: "mainChallenges", col: "main_challenges", t: "jsonb" },
      { k: "stillExploring", col: "still_exploring", t: "bool" },
      { k: "serviceInterest", col: "service_interest", t: "text" },
      { k: "serviceInterests", col: "service_interests", t: "jsonb" },
      { k: "needsHelpChoosing", col: "needs_help_choosing", t: "bool" },
  ...
  vehicles: {
    t: "vehicles",
    fields: [
      { k: "customerId", col: "customer_id", t: "int" },
      { k: "name", col: "name", t: "text" },
      { k: "plate", col: "plate", t: "text" },
      { k: "vehicleType", col: "vehicle_type", t: "text" },
      { k: "status", col: "status", t: "text" },
      { k: "lastLocation", col: "last_location", t: "text" },
      ...
      { k: "lastUpdate", col: "last_update", t: "ts" },
      { k: "createdAt", col: "created_at", t: "ts" },
      { k: "updatedAt", col: "updated_at", t: "ts" },
    ],
  },
  ...
  geofences: {
    ...
    fields: [
      ...
      { k: "latitude", col: "latitude", t: "text" },
      { k: "longitude", col: "longitude", t: "text" },
      { k: "radiusKm", col: "radius_km", t: "float8" },
      { k: "enabled", col: "enabled", t: "bool" },
      { k: "createdAt", col: "created_at", t: "ts" },
      { k: "updatedAt", col: "updated_at", t: "ts" },
    ],
  },
  geofenceStates: {
    t: "geofence_states",
    fields: [
      { k: "geofenceId", col: "geofence_id", t: "int" },
      { k: "vehicleId", col: "vehicle_id", t: "int" },
      { k: "inside", col: "inside", t: "bool" },
      { k: "updatedAt", col: "updated_at", t: "ts" },
    ],
  },
  alerts: {
    ...
    fields: [
      { k: "vehicleId", col: "vehicle_id", t: "int" },
      { k: "customerId", col: "customer_id", t: "int" },
      { k: "alertType", col: "alert_type", t: "text" },
      { k: "message", col: "message", t: "text" },
      { k: "status", col: "status", t: "text" },
      { k: "createdAt", col: "created_at", t: "ts" },
  ...
  quotations: {
    ...
    fields: [
      { k: "customerId", col: "customer_id", t: "int" },
      { k: "number", col: "number", t: "text" },
      { k: "items", col: "items", t: "jsonb" },
      { k: "total", col: "total", t: "float8" },
      { k: "currency", col: "currency", t: "text" },
      { k: "status", col: "status", t: "text" },
      { k: "validUntil", col: "valid_until", t: "ts" },
      { k: "notes", col: "notes", t: "text" },
      { k: "createdAt", col: "created_at", t: "ts" },
      { k: "updatedAt", col: "updated_at", t: "ts" },
    ],
  ...
  invoices: {
    t: "invoices",
    fields: [
      { k: "quotationId", col: "quotation_id", t: "int" },
      { k: "customerId", col: "customer_id", t: "int" },
      { k: "number", col: "number", t: "text" },
      { k: "items", col: "items", t: "jsonb" },
      { k: "total", col: "total", t: "float8" },
      { k: "amountPaid", col: "amount_paid", t: "float8" },
      { k: "status", col: "status", t: "text" },
      { k: "dueAt", col: "due_at", t: "ts" },
      { k: "paidAt", col: "paid_at", t: "ts" },
      { k: "createdAt", col: "created_at", t: "ts" },
      { k: "updatedAt", col: "updated_at", t: "ts" },
    ],
  },
  deposits: {
    t: "deposits",
    fields: [
      { k: "invoiceId", col: "invoice_id", t: "int" },
      { k: "amount", col: "amount", t: "float8" },
      { k: "method", col: "method", t: "text" },
      { k: "reference", col: "reference", t: "text" },
      { k: "createdAt", col: "created_at", t: "ts" },
    ],
  },
  pageViews: {
...
const SELECT_COLS: Record<CollectionName, string> = {
  ...
  leads: `id::int AS "id", first_name AS "firstName", last_name AS "lastName", email, phone_country_code AS "phoneCountryCode", phone, dedupe_key AS "dedupeKey", company, position, fleet_size AS "fleetSize", main_challenge AS "mainChallenge", main_challenges AS "mainChallenges", still_exploring AS "stillExploring", service_interest AS "serviceInterest", service_interests AS "serviceInterests", needs_help_choosing AS "needsHelpChoosing", lead_source AS "leadSource", campaign, utm_source AS "utmSource", utm_medium AS "utmMedium", utm_campaign AS "utmCampaign", utm_content AS "utmContent", landing_page AS "landingPage", agent_code AS "agentCode", status, assigned_salesperson_id::int AS "assignedSalespersonId", ${tsSql("follow_up_date")} AS "followUpDate", follow_up_notes AS "followUpNotes", ${tsSql("last_activity_at")} AS "lastActivityAt", consent, ${tsSql("created_at")} AS "createdAt", ${tsSql("updated_at")} AS "updatedAt"`,
  ...
  assessments: `id::int AS "id", lead_id::int AS "leadId", assessment_type AS "assessmentType", fleet_size AS "fleetSize", main_challenge AS "mainChallenge", main_challenges AS "mainChallenges", still_exploring AS "stillExploring", service_interest AS "serviceInterest", service_interests AS "serviceInterests", needs_help_choosing AS "needsHelpChoosing", details, submission_path AS "submissionPath", ${tsSql("created_at")} AS "createdAt"`,
  ...
  quotations: `id::int AS "id", customer_id::int AS "customerId", number, items, total::float8 AS "total", currency, status, ${tsSql("valid_until")} AS "validUntil", notes, ${tsSql("created_at")} AS "createdAt", ${tsSql("updated_at")} AS "updatedAt"`,
  invoices: `id::int AS "id", quotation_id::int AS "quotationId", customer_id::int AS "customerId", number, items, total::float8 AS "total", amount_paid::float8 AS "amountPaid", status, ${tsSql("due_at")} AS "dueAt", ${tsSql("paid_at")} AS "paidAt", ${tsSql("created_at")} AS "createdAt", ${tsSql("updated_at")} AS "updatedAt"`,
  deposits: `id::int AS "id", invoice_id::int AS "invoiceId", amount::float8 AS "amount", method, reference, ${tsSql("created_at")} AS "createdAt"`,
